...
export default class MediaPlayer extends Component {
  ...
  render() {
    ...
    return (
      <Media>
        <div >
          <div className="media-wrapper" style={{ marginLeft: 1000, marginTop:-10 }}>

            {this.state.songs_list.map((s) => (
              <ul>
                <button className="semi-transparent-button" style={{marginLeft:"-40px",marginTop:"-20px"}}
                  onClick={() => {
                    this.setState({
            ...
            <div>
            <div>
              <div className="controls" style={{ marginTop: "-120px"}}>
